...
export const Hero = () => {
  return (
    ...
    <button className=" bg-primary font-semibold w-max left- text-black gap-3 p-4 outline-black outline-dashed outline-3 -outline-offset-4  rounded-md bg-yellow-400 transition-transform transform hover:scale-105 flex items-center sm:ml-[calc(2*30%)] ml-[20%]">
